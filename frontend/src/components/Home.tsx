            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <button
                  ...
                  className="bg-gray-100 dark:bg-white/5 hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-500/10 dark:hover:text-blue-400 text-gray-600 dark:text-gray-400 font-bold py-2.5 rounded-xl text-[10px] border-none cursor-pointer flex items-center justify-center gap-1 shrink-0 mt-4 transition-colors"
                >
    ...
    >
      ...
      <div className="absolute top-0 right-0 z-50 flex items-center gap-3">
        <button
          ...
          className="bg-white/80 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-gray-700 text-gray-750 dark:text-gray-300 px-4 py-2 rounded-xl text-xs font-bold hover:bg-gray-50 dark:hover:bg-white/10 active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer shadow-xxs border-none"
        >
          Masuk Dashboard
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 mt-8">
        <div className="flex-grow flex-1 text-center lg:text-left flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 mt-4 justify-center lg:justify-start">
            <button 
              onClick={() => setActiveTab('detector')}
              className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3.5 rounded-xl text-sm font-semibold hover:shadow-lg hover:shadow-blue-500/20 active:scale-98 transition-all flex items-center justify-center gap-2 border-none cursor-pointer"
            >
              Mulai Deteksi Teks
            ...
            <button 
              ...
              className="w-full sm:w-auto bg-white dark:bg-white/10 border border-gray-250 dark:border-gray-700 text-gray-755 dark:text-gray-300 px-8 py-3.5 rounded-xl text-sm font-semibold hover:bg-gray-50 dark:hover:bg-white/15 active:scale-98 transition-all flex items-center justify-center gap-2 cursor-pointer border-none"
            >
